...
const Navbar = () => {
  ...
  return (
    <nav
      className="navbar bg-[#4DBDFF] text-white shadow-lg px-4 py-2 fixed w-full top-3 left-0 z-50"
    ...
    >
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-[#3947D8] text-[#F7F7F8] rounded-box z-[1] mt-3 w-52 p-2 shadow-lg"
          >
            <li>
              <a href="/" className="hover:bg-[#0097A7]">
                Home Page
              </a>
            </li>
            <li>
